...
export function StarButton({
  ...
  return (
    ...
    >
      ...
      />
      {/* Border + star-dot texture — black dots, white/15 border */}
      <div
        className="absolute inset-0 z-[4] overflow-hidden rounded-[inherit] text-black"
        style={{
      ...
      {/* Label — white gradient text, clearly visible */}
      <span
        className="z-10 relative bg-gradient-to-t from-white to-neutral-400 inline-block text-transparent bg-clip-text"
        style={{
